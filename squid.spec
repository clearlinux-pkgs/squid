...
Source0  : https://squid.mirror.globo.tech/archive/6/squid-6.11.tar.gz
Source1  : squid.service
Source2  : squid.tmpfiles
Source3  : https://squid.mirror.globo.tech/archive/6/squid-6.11.tar.gz.asc
...
%setup -q -n squid-6.11
cd %{_builddir}/squid-6.11
%patch -P 1 -p1
pushd ..
cp -a squid-6.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726520029
