...
Version  : 6.10
Release  : 30
URL      : https://squid.mirror.globo.tech/archive/6/squid-6.10.tar.gz
Source0  : https://squid.mirror.globo.tech/archive/6/squid-6.10.tar.gz
Source1  : squid.service
Source2  : squid.tmpfiles
Source3  : https://squid.mirror.globo.tech/archive/6/squid-6.10.tar.gz.asc
...
%setup -q -n squid-6.10
cd %{_builddir}/squid-6.10
%patch -P 1 -p1
pushd ..
cp -a squid-6.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720030705
