...
Version  : 5.0.3
Release  : 12
URL      : http://squid.mirror.colo-serv.net/archive/5/squid-5.0.3.tar.xz
Source0  : http://squid.mirror.colo-serv.net/archive/5/squid-5.0.3.tar.xz
Source1  : squid.service
Source2  : squid.tmpfiles
Source3  : http://squid.mirror.colo-serv.net/archive/5/squid-5.0.3.tar.xz.asc
...
%prep
%setup -q -n squid-5.0.3
cd %{_builddir}/squid-5.0.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594753273
...
cp %{_builddir}/squid-5.0.3/COPYING %{buildroot}/usr/share/package-licenses/squid/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/squid-5.0.3/errors/COPYRIGHT %{buildroot}/usr/share/package-licenses/squid/e4b03a8e99bffb9f286bc85f80169006f4e6b7f7
cp %{_builddir}/squid-5.0.3/libltdl/COPYING.LIB %{buildroot}/usr/share/package-licenses/squid/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
