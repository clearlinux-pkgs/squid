...
Source0  : https://squid.mirror.globo.tech/archive/6/squid-6.12.tar.gz
Source1  : squid.service
Source2  : squid.tmpfiles
Source3  : https://squid.mirror.globo.tech/archive/6/squid-6.12.tar.gz.asc
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729093961
...
cp %{_builddir}/squid-%{version}/errors/COPYRIGHT %{buildroot}/usr/share/package-licenses/squid/20232099e45fc72733a4713e6aa633c5c91a9911 || :
...
/usr/share/package-licenses/squid/20232099e45fc72733a4713e6aa633c5c91a9911
